...
Public Class CameraCaptureAddNewuserFrm
    ...
    Private Sub CameraCaptureAddNewuserFrm_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
        OnTopFrm()
    End Sub

    Private Sub CameraCaptureAddNewuserFrm_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        cam.Dispose()
    End Sub

    Private Sub CameraCaptureAddNewuserFrm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cam_FrameSaved(ByVal capImage As System.Drawing.Bitmap, ByVal imgPath As String) Handles cam.FrameSaved
        StartAddNewUserFrm.PicUsers.Image = New Bitmap(capImage)
        Me.Close()
    End Sub
    ...
    Private Sub btnOpen_Click(sender As Object, e As EventArgs) Handles btnOpen.Click
        If OpenImageFile.ShowDialog = Windows.Forms.DialogResult.OK AndAlso OpenImageFile.FileName <> Nothing Then
            ...
            StartAddNewUserFrm.PicUsers.Image = PictureBox1.Image
            Me.Close()
        End If
    End Sub
        ...
        Try
            ...
            If F IsNot Nothing Then
                ...
                Try
                    ...
                    StartAddNewUserFrm.PicUsers.Image = Nothing
                    StartAddNewUserFrm.PicUsers.Image = Bmp
