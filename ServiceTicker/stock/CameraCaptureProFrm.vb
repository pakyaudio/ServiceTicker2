...
Public Class CameraCaptureProFrm
    ...
    Private Sub cam_FrameSaved(ByVal capImage As System.Drawing.Bitmap, ByVal imgPath As String) Handles cam.FrameSaved
        ...
        Call SavePictureToDB(PictureBox1, ProductDetailEditFrm.txtPDproID.Text, ProductDetailEditFrm.tempPic)
        Call ProductDetailEditFrm.LoadPictureList(ProductDetailEditFrm.txtPDproID.Text)
        Me.Close()
    End Sub
