...
Public Class CheckStockCheckedA4ReportPrintFrm

    Private Sub CheckStockCheckedA4ReportPrintFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim ttext As New ReportParameter("protype", ViewCheckStockSNCheckedFrm.cbbProduct.Text)
