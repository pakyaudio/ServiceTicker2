...
Public Class BillingINV1A4CRPrintFrm

    Private Sub BillingINV1A4CRPrintFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cry.Load(rptPathA4 & "BillingINV1A4CrystalReport.rpt")
