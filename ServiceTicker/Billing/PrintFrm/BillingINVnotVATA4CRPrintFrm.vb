...
Public Class BillingINVnotVATA4CRPrintFrm

    Private Sub BillingINVnotVATA4CRPrintFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cry.Load(rptPathA4 & "BillingINVnotVATA4CrystalReport.rpt")
        ...
        Try
            paramField8.ParameterFieldName = "date_price"
            Dim str8 As String = TaxInvoiceFrm.cbbExDay.Text
        ...
        Try
            ...
            If TaxInvoiceFrm.cbDateSend.Checked = True Then
                str9 = Convert.ToDateTime(TaxInvoiceFrm.DateTimePicker2.Value.AddDays(CInt(TaxInvoiceFrm.cbbExDay.Text))).ToString("d MMMM yyyy",
                                CultureInfo.CreateSpecificCulture("th-TH"))
            Else
                str9 = "-"
            End If
