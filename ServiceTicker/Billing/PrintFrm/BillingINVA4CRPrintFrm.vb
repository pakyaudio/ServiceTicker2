...
Public Class BillingINVA4CRPrintFrm

    Private Sub BillingINVA4CRPrintFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cry.Load(rptPathA4 & "BillingINVA4CrystalReport.rpt")
