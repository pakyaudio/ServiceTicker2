...
Public Class popupCeditFrm
    ...
    Private Sub popupCeditFrm_Load(sender As Object, e As EventArgs) Handles Me.Load
        Me.BringToFront()
        Me.Icon = MainFrm.Icon
        My.Computer.Audio.Play(My.Resources.CratePop, AudioPlayMode.Background)
        ...
        For Each openForm As popupCeditFrm In popupCeditFrm.openForms
            openForm.Top -= Me.Height + 5
        Next

        'Add this form from the open form list.
        popupCeditFrm.openForms.Add(Me)
    End Sub
...
#Region " Variables "
    ...
    ''' </summary>
    Private Shared openForms As New List(Of popupCeditFrm)
...
#Region " Event Handlers "
    ...
    Private Sub ToastForm_FormClosed(ByVal sender As Object, ByVal e As FormClosedEventArgs) Handles MyBase.FormClosed
        ...
        popupCeditFrm.openForms.Remove(Me)
    End Sub
