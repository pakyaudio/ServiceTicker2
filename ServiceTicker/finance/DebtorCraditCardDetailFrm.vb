Public Class DebtorCraditCardDetailFrm
    Private Sub GetBank()
        Try
    ...
    Private Sub GetCard()
        Try
            strSQL = "SELECT card_type FROM credit_card ORDER BY card_type;"
            cmd = New MySql.Data.MySqlClient.MySqlCommand(strSQL, ConnectionDB)
            Call open_connection()
            Dr = cmd.ExecuteReader
            If Dr.HasRows Then
                While Dr.Read
                    Me.ComboBox2.Items.Add(Dr.Item("card_type"))
                End While
            End If
        Catch ex As Exception
    ...
    Private Sub DebtorCheckDetailFrm_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Me.Location = New Point(System.Windows.Forms.Cursor.Position.X - 700, System.Windows.Forms.Cursor.Position.Y - 100)
        Call GetBank()
        Call GetCard()
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            If cashSelectDetail = "CashSaleFrm" Then
                CashSaleFrm.txtCashByselectPayment.Text = Me.ComboBox2.Text & "/" & Me.ComboBox1.Text & "/" & Me.TextBox1.Text
            ElseIf cashSelectDetail = "CashFrm" Then
                CashFrm.txtCashByselectPayment.Text = Me.ComboBox2.Text & "/" & Me.ComboBox1.Text & "/" & Me.TextBox1.Text
            Else
                DebtorFrm.txtDTpayments.Text = Me.ComboBox2.Text & "/" & Me.ComboBox1.Text & "/" & Me.TextBox1.Text
            End If
            Me.Close()
        End If
    End Sub
