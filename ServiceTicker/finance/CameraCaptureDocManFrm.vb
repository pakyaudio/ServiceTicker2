...
Public Class CameraCaptureDocManFrm
    ...
    Private Sub CameraCaptureCustomerFrm_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
        OnTopFrm()
    End Sub

    Private Sub CameraCaptureCustomerFrm_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        cam.Dispose()
    End Sub

    Private Sub CameraCaptureCustomerFrm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cam_FrameSaved(ByVal capImage As System.Drawing.Bitmap, ByVal imgPath As String) Handles cam.FrameSaved
        Dim imgcam As Bitmap = New Bitmap(capImage)
        PictureBox1.Image = imgcam
        Call SavePictureToDB(PictureBox1, DocumentManagerFrm.dgDM.CurrentRow.Cells(1).Value, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss",
                                                                                                                   CultureInfo.CreateSpecificCulture("en-US")))
        Call DocumentManagerFrm.LoadPictureList(DocumentManagerFrm.dgDM.CurrentRow.Cells(1).Value)
        Me.Close()
    End Sub
