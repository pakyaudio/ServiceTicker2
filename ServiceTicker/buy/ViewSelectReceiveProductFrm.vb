...
Public Class ViewSelectReceiveProductFrm
    ...
    Private Sub dgVSRP_CellMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles dgVSRP.CellMouseClick
        If Me.dgVSRP.Rows.Count <> 0 Then
            If e.Button = Windows.Forms.MouseButtons.Left Then
                Call LoadPictureList(Me.dgVSRP.CurrentRow.Cells(0).Value, Me.dgVSRP.CurrentRow.Cells(1).Value)
            End If
        End If
    End Sub
End Class