...
Public Class ReceviceReportA5PrintFrm
    Dim datetime As String

    Private Sub ReceviceReportA5PrintFrm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        OnTopFrm()
    End Sub
