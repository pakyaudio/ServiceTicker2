...
Public Class CameraCaptureAttactBillFrm
    Friend view1 As String
    ...
    Private Sub cam_FrameSaved(ByVal capImage As System.Drawing.Bitmap, ByVal imgPath As String) Handles cam.FrameSaved
        ...
        If view1 = "View1" Then
            Call SavePictureToDB(PictureBox1, ReceiveReportFrm.dgVR.CurrentRow.Cells(0).Value, ReceiveReportFrm.dgVR.CurrentRow.Cells(1).Value)
            Call ViewReportReceiveProductFrm.LoadPictureList(ReceiveReportFrm.dgVR.CurrentRow.Cells(0).Value, ReceiveReportFrm.dgVR.CurrentRow.Cells(1).Value)
            Me.Close()
        Else
            Call SavePictureToDB(PictureBox1, ReceiveProductFrm.txtRPbuy_id.Text, ReceiveProductFrm.txtRPid.Text)
        ...
        If OpenImageFile.ShowDialog = Windows.Forms.DialogResult.OK AndAlso OpenImageFile.FileName <> Nothing Then
            If view1 = "View1" Then
                For Each file As String In OpenImageFile.FileNames
                    ...
                    'SaveDataFixFrm.PictureBox2.Image = PictureBox1.Image
                    Call SavePictureToDB(PictureBox1, ReceiveReportFrm.dgVR.CurrentRow.Cells(0).Value, ReceiveReportFrm.dgVR.CurrentRow.Cells(1).Value)
