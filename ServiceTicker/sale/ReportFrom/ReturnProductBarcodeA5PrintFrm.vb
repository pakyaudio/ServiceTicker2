...
Public Class ReturnProductBarcodeA5PrintFrm
    Dim DateTime As String

    Private Sub ReturnProductBarcodeA5PrintFrm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        OnTopFrm()
    End Sub
