...
Public Class ReportSaleA5PrintFrm

    Private Sub ReportSaleA5PrintFrm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        OnTopFrm()
    End Sub
    Private Sub ReportSaleA5PrintFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
