Public Class ReturnProductA5ReportPrintFrm

    Private Sub ReturnProductA5ReportPrintFrm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        OnTopFrm()
    End Sub

    Private Sub ReturnProductA5ReportPrintFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
