...
Public Class ReturnClaimsToCusReportPrintFrmA5

    Private Sub ReturnClaimsToCusReportPrintFrmA5_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        OnTopFrm()
    End Sub

    Private Sub ReturnClaimsToCusReportPrintFrmA5_Load(sender As Object, e As EventArgs) Handles MyBase.Load
