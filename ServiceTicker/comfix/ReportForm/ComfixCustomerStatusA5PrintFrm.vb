...
Public Class ComfixCustomerStatusA5PrintFrm
    Dim sed As String

    Private Sub ComfixCustomerStatusA5PrintFrm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        OnTopFrm()
    End Sub
