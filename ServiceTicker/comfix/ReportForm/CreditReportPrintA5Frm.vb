...
Public Class CreditReportPrintA5Frm

    Private Sub CreditReportPrintA5Frm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        OnTopFrm()
    End Sub

    Private Sub CreditReportPrintA5Frm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
