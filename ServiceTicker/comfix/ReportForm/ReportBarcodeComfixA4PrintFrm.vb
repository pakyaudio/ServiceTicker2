...
Public Class ReportBarcodeComfixA4PrintFrm
    Dim datetime As String

    Private Sub ReportBarcodeComfixA4PrintFrm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        OnTopFrm()
    End Sub
