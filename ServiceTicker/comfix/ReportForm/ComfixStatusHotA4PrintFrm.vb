...
Public Class ComfixStatusHotA4PrintFrm
    Dim sed As String

    Private Sub ComfixStatusHotA4PrintFrm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        OnTopFrm()
    End Sub
