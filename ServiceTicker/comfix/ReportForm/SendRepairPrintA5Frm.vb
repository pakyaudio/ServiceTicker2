...
Public Class SendRepairPrintA5Frm
    ...
    Private Sub SendRepairPrintA5Frm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        OnTopFrm()
    End Sub
    ...
    Private Sub snBindingSource_CurrentChanged(sender As Object, e As EventArgs)
