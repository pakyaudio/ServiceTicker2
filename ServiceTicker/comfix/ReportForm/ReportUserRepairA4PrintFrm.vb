...
Public Class ReportUserRepairA4PrintFrm

    Private Sub ReportUserRepairA4PrintFrm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        OnTopFrm()
    End Sub

    Private Sub ReportUserRepairA4PrintFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
