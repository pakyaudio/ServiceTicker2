...
Public Class ReceiptReportA5PrintFrm
    Dim tlall As Decimal

    Private Sub ReceiptReportA5PrintFrm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        OnTopFrm()
    End Sub

    Private Sub ReceiptReportA5PrintFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
