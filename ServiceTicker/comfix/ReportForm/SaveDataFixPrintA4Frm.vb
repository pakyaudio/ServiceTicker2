...
Public Class SaveDataFixPrintA4Frm

    Private Sub SaveDataFixPrintA4Frm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        OnTopFrm()
    End Sub

    Private Sub SaveDataFixPrintA4Frm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
