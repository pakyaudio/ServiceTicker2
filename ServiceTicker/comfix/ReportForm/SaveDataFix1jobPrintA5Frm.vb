...
Public Class SaveDataFix1jobPrintA5Frm

    Private Sub SaveDataFix1jobPrintA5Frm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        OnTopFrm()
    End Sub

    Private Sub SaveDataFix1jobPrintA5Frm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
