...
Public Class CameraCaptureRepairStatusFrm
    ...
    Private Sub cam_FrameSaved(ByVal capImage As System.Drawing.Bitmap, ByVal imgPath As String) Handles cam.FrameSaved
        ...
        Call SavePictureToDB(PictureBox1, RepairStatusFrm.txtRSfix_id.Text, RepairStatusFrm.txtSN.Text)
        Call RepairStatusFrm.LoadPictureList(RepairStatusFrm.txtRSfix_id.Text)
        Me.Close()
    End Sub
    ...
    Private Sub btnScanner_Click_1(sender As Object, e As EventArgs) Handles btnScanner.Click
        Try
