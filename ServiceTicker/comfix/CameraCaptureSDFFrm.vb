...
Public Class CameraCaptureSDFFrm
    ...
    Private Sub cam_FrameSaved(ByVal capImage As System.Drawing.Bitmap, ByVal imgPath As String) Handles cam.FrameSaved
        ...
        Call SavePictureToDB(PictureBox1, SaveDataFixFrm.lblAutoNumber.Text, SaveDataFixFrm.txtSDFfixSN.Text)
        Call SaveDataFixFrm.LoadPictureList(SaveDataFixFrm.lblAutoNumber.Text)
        Me.Close()
    End Sub
